...
export const exerciseStages: ExerciseStage[] = [
  {id:'chest-heavy-press',muscleGroupId:'chest',order:1,title:'Тяжёлый жим',shortTitle:'Тяжёлый жим',description:'Основной жим для прогрессии силы и рабочего веса.',reps:'5–8',sets:'3–4',rir:'1–3',rest:'2–3 мин'},
  ...
  {id:'triceps-compound',muscleGroupId:'triceps',order:1,title:'Тяжёлое упражнение',shortTitle:'Тяжёлое',description:'Дополнительная тяжёлая работа, если трицепс не утомлён грудными жимами.',reps:'6–10',sets:'3',rir:'1–3',rest:'2–3 мин',optional:true},
  {id:'triceps-overhead',muscleGroupId:'triceps',order:2,title:'Разгибание над головой',shortTitle:'Над головой',description:'Локальная работа при поднятом плече.',reps:'8–15',sets:'3',rir:'1–2',rest:'75–120 сек'},
  {id:'triceps-pushdown',muscleGroupId:'triceps',order:3,title:'Разгибание вниз',shortTitle:'Разгибание вниз',description:'Контролируемая работа на блоке с низкой общей усталостью.',reps:'10–20',sets:'3',rir:'0–2',rest:'60–90 сек'},
  ...
  {id:'legs-accessory',muscleGroupId:'legs',order:3,title:'Дополняющее упражнение',shortTitle:'Дополнение',description:'Закрывает недополученную работу задней поверхности или квадрицепса.',reps:'10–20',sets:'3',rir:'0–2',rest:'60–120 сек'},
  {id:'legs-calves',muscleGroupId:'legs',order:4,title:'Икры',shortTitle:'Икры',description:'Дополнительная работа икроножных и камбаловидной мышц.',reps:'8–20',sets:'3–4',rir:'0–2',rest:'60–90 сек',optional:true},
  {id:'shoulders-press',muscleGroupId:'shoulders',order:1,title:'Жим',shortTitle:'Жим',description:'Необязательная работа передней дельты и трицепса.',reps:'6–12',sets:'3',rir:'1–3',rest:'90–150 сек',optional:true},
  {id:'shoulders-lateral',muscleGroupId:'shoulders',order:2,title:'Средняя дельта',shortTitle:'Средняя дельта',description:'Обязательная работа отведением плеча.',reps:'10–20',sets:'3–4',rir:'0–2',rest:'60–90 сек'},
  {id:'shoulders-rear',muscleGroupId:'shoulders',order:3,title:'Задняя дельта',shortTitle:'Задняя дельта',description:'Обязательная работа задней дельты и мышц лопатки.',reps:'12–20',sets:'3–4',rir:'0–2',rest:'60–90 сек'},
];
